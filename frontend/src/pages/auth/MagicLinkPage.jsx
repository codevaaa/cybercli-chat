    ...
    <div className="min-h-screen flex items-center justify-center section-padding pt-24 pb-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-foreground-muted">Log in without a password. We will email you a secure link.</p>
        </div>
        ...
        {sent ? (
          <div className="card p-8 text-center">
            ...
            <p className="text-sm text-foreground-muted mb-6">We sent a magic login link to {email}</p>
        ...
        <p className="text-center text-sm text-foreground-muted mt-6">
          Prefer password?{' '}
          <Link to="/auth/login" className="text-accent hover:underline font-medium">Log in with password</Link>
        </p>
      </div>
    </div>
  )
