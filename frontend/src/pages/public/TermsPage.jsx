...
const SECTIONS = [
  {
    ...
    content: `By accessing or using Codeva ("the Service"), operated by Codeva ("we," "us," or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service. These Terms constitute a legally binding agreement between you and Codeva.
...
We reserve the right to suspend or terminate accounts that violate this policy, and to report illegal activity to appropriate law enforcement authorities.`,
  },
  {
    ...
    content: `**Your Content**: You retain ownership of all content you input into the Service ("User Content"). By using the Service, you grant Codeva a limited, non-exclusive, worldwide, royalty-free license to process, transmit, and store your User Content solely for the purpose of providing the Service.
...
**Service IP**: The Service, including its software, design, features, and documentation, is owned by Codeva and protected by intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of the Service.

**Feedback**: Any feedback, suggestions, or ideas you provide about the Service may be used by Codeva without compensation or attribution to you.`,
  },
  {
    id: 'privacy',
...
**Limitation of Liability**: To the maximum extent permitted by applicable law, Codeva shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising from your use of or inability to use the Service.
