        ...
        <div className="container-custom">
          <ScrollReveal>
            <Link to={`/blog/${BLOG_POSTS[0].slug}`} className="block group">
              <motion.div
                className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${BLOG_POSTS[0].gradient} border border-border-subtle p-10 lg:p-14`}
                whileHover={{ y: -4 }}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-foreground-muted leading-relaxed max-w-2xl mb-8">{BLOG_POSTS[0].excerpt}</p>
            ...
            {BLOG_POSTS.slice(1).map((post, i) => (
              <ScrollReveal key={post.slug} delay={i * 0.1}>
                <Link to={`/blog/${post.slug}`} className="block group h-full">
                  <motion.div
                    className={`relative h-full overflow-hidden rounded-2xl bg-gradient-to-br ${post.gradient} border border-border-subtle p-7`}
                  ...
                  >
                    ...
                    <div className="relative flex flex-col h-full">
                      ...
                      <h3 className="text-xl font-semibold text-foreground-primary mb-3 leading-snug group-hover:text-accent transition-colors flex-1">
                        {post.title}
                      </h3>
                      ...
                      <div className="flex items-center gap-3 mt-auto">
                        ...
                        <span className="text-xs text-foreground-muted ml-auto">{post.date}</span>
                      </div>
                    </div>
                  </motion.div>
                </Link>
