...
export const MODEL_CARDS = [
  {
    ...
    name: 'Madhav (OpenCode v4)',
    provider: 'OpenCode AI Compute Node',
  ...
  },
  {
    ...
    name: 'Bheem (ApiFree GPT-4o)',
    provider: 'ApiFree LLM Compute Node',
