...
const FEATURES = [
  {
    ...
    desc: 'CyberCli can write and edit code across multiple files, manage complex architectural changes, and directly execute commands in your terminal.',
    icon: FileCode
  },
  {
    title: 'Answers questions about your code',
    desc: 'Powered by advanced RAG capabilities, CyberCli instantly searches your entire codebase to explain logic, find bugs, or summarize project structure.',
    icon: Search
  },
  {
    title: 'Executes builds and tests',
    desc: 'CyberCli autonomously runs builds, linters, and tests. If it encounters a bug, it seamlessly debugs and fixes the error without breaking your flow.',
    icon: Monitor
  }
]
...
const FAQS = [
  {
    q: 'What is CyberCli Code?',
    a: 'CyberCli Code is an agentic coding assistant that lives in your terminal. It understands your codebase, writes code, runs tests, and interacts with tools using 200K+ elite models.'
  },
  {
    q: 'How does it compare to GitHub Copilot?',
    a: 'Unlike Copilot which primarily focuses on inline autocompletion, CyberCli Code is an autonomous agent. You can ask it to "build a new authentication flow", and it will create files, install dependencies, and test the code across your entire repository.'
  },
  {
    q: 'Is my codebase secure?',
    a: 'Yes. CyberCli operates with a zero-trust architecture. You must explicitly approve terminal commands and file operations before they are executed. Data is encrypted and models do not train on your private code by default.'
  },
  {
    q: 'Which models does it use?',
    a: 'CyberCli integrates with the OpenRouter Gateway, allowing you to seamlessly switch between GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro, and specialized coding models like DeepSeek Coder V2.'
  }
]

export default function CyberCliCodePage() {
        ...
        <div className="container-custom max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            <div className="flex items-center gap-3 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
              ...
              <span className="text-sm font-medium tracking-wide">CyberCli Code</span>
            </div>
          </motion.div>
          ...
          >
            Built for the terminal, CyberCli Code empowers you to ship faster by letting AI write, test, and debug code right inside your local environment.
          </motion.p>
        ...
        <div className="container-custom max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center px-4 py-3 bg-[#1A1A1A] border-b border-white/5">
              ...
              <div className="mx-auto text-xs font-mono text-[#888888]">~/projects/cybercli-app</div>
            </div>
            {/* Terminal Body */}
            <div className="p-6 font-mono text-sm leading-relaxed text-[#D4D4D4] overflow-x-auto">
              <div className="flex gap-3 mb-2">
                <span className="text-emerald-400">➜</span>
                <span className="text-blue-400">cybercli-app</span>
                <span className="text-white">cybercli "add a Stripe webhook endpoint to the backend"</span>
              </div>
              <div className="text-[#888888] mb-4">
                [CyberCli is analyzing the repository...]
              </div>
              
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-4">
                <div className="text-orange-400 font-bold mb-2">CyberCli Planner</div>
        ...
        <div className="container-custom max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-[#A1A1AA] text-lg max-w-2xl mx-auto">
              CyberCli doesn't just autocomplete code—it takes ownership of full tasks, reasoning about complex architectures autonomously.
            </p>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="container-custom max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-serif mb-16" style={{ fontFamily: "'Instrument Serif', serif" }}>
            ...
            CyberCli <span className="text-emerald-400 italic">completes</span>.
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            ...
            <div className="bg-[#D97757]/10 border border-[#D97757]/30 p-8 rounded-2xl relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-6 relative z-10">
                ...
                <h3 className="text-xl font-bold text-white">CyberCli Code</h3>
              </div>
